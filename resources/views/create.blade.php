    ...
    <div class="w-full">
        ...
        <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
            <div class="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
                <p class="text-3xl font-bold leading-7 text-center">質問投稿</p>
                <form action="/conform" method="post">
                    ...
                    <div class="md:flex items-center mt-12">
                        ...
                        <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label class="font-semibold leading-none">教科</label>
                    ...
                    <div class="md:flex items-center mt-8">
                        <div class="w-full flex flex-col">
                            <label class="font-semibold leading-none">タイトル</label>
                    ...
                    <div>
                        <div class="w-full flex flex-col mt-8">
                            <label class="font-semibold leading-none">質問内容</label>
                    ...
                    <div>
                        <div class="w-full flex flex-col mt-8">
                            ...
                            <input type="file" name="image" class="mt-4"></textarea>
                        </div>
                    </div>
